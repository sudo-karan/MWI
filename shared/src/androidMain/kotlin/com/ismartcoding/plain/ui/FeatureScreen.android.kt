...
import com.ismartcoding.plain.ui.screens.AppFilesScreen
...
import com.ismartcoding.plain.ui.screens.DocumentsScreen
...
actual fun FeatureScreen(feature: Feature, onBack: () -> Unit) {
    when (feature.id) {
        ...
        "notifications" -> NotificationsScreen(onBack)
